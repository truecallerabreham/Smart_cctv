...
const VideoSidebar = ({
  ...
  return (
    <div className="fixed right-0 top-0 w-96 h-screen border-l border-amber-900 bg-black flex flex-col z-20">
      <div className="p-4 border-b border-amber-900">
        <h3 className="text-2xl font-bold text-amber-500 mb-2 text-center">VIDEO LIBRARY</h3>
        <Button
        ...
        {isProcessingVideo && (
          <div className="mt-4 p-4 bg-amber-950 border border-amber-800 rounded">
            <div className="flex flex-col items-center space-y-3">
              ...
              <div className="text-center">
                <div className="text-sm text-amber-400 font-bold">PROCESSING</div>
                <div className="text-xs text-amber-300 mt-1">Please wait...</div>
              </div>
          ...
          return (
            ...
            >
              ...
              <div className="p-2">
                ...
                <div className="flex items-center justify-between mt-1">
                  ...
                  {video.processingStatus && (
                    <p className={`text-xs ${
                      video.processingStatus === 'completed' ? 'text-emerald-400' :
                      video.processingStatus === 'failed' ? 'text-red-500' :
                      'text-yellow-400'
                    }`}>
              ...
              <Button
                ...
                size="icon"
                className="absolute top-1 right-1 w-6 h-6 bg-amber-600 hover:bg-amber-700 text-white opacity-0 group-hover:opacity-100 transition-opacity"
              >
                <X className="w-3 h-3" />
              </Button>
            </div>
