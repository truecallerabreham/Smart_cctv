...
const ChatInput = ({
  ...
  return (
    <div className="border-t border-amber-900 bg-black p-4">
          ...
          <div className="relative inline-block bg-gray-800 border border-gray-700 rounded-lg p-2">
            <div className="flex items-center space-x-2">
              ...
              <Button
                ...
                size="icon"
                className="w-6 h-6 bg-amber-600 hover:bg-amber-700 text-white"
              >
                <X className="w-3 h-3" />
              </Button>
            </div>
      ...
      <div className="max-w-4xl mx-auto flex items-center space-x-2">
        ...
        <Input
          ...
          className="flex-1 bg-gray-900 border-gray-700 text-white placeholder-gray-500 font-mono focus:border-amber-500 focus:ring-amber-500"
          disabled={isTyping}
        />
        <Button
          onClick={onSendMessage}
          disabled={(!inputMessage.trim() && !attachedFile) || isTyping}
          className="bg-amber-600 hover:bg-amber-700 text-white border-0 transition-colors"
        >
      ...
      <div className="max-w-4xl mx-auto mt-2">
        <p className="text-xs text-gray-500 text-center">
          SYSTEM STATUS: ONLINE | INCIDENT MONITORING: ACTIVE
        </p>
      </div>
    </div>
  );
