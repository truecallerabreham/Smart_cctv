...
from smartguard_api.agent import LLMAgent
...
async def root():
    ...
    """
    return {"message": "Welcome to SmartGuard API. Visit /docs for documentation"}
...
async def upload_video(file: UploadFile = File(...)):
    ...
    try:
        ...
        return VideoUploadResponse(message="Video uploaded successfully", video_path=str(video_path.resolve()))
    except Exception as e:
...
def run_api(port, host):
    ...
    uvicorn.run("smartguard_api.api:app", host=host, port=port, loop="asyncio")
